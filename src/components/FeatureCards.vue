...
.list_lined > li {padding-left:20px; position: relative; }
.list_lined > li::before { content: ""; width: 4px; height: 1px; background-color:#67676F; position: absolute; top: 11px; left:8px; }
.list_lined > li > p {font-size:16px;}
...
@media (max-width: 768px) {
    ...
    .list_dotted > li + li { margin-top: 8px; }
    .list_dotted > li > p, .list_lined > li > p { font-size: 1.4rem; line-height: 1.4; letter-spacing: -0.01em; }
}
</style>
