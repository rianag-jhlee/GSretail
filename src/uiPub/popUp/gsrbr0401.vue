        ...
        return {
            ...
            langData: {
                ...
                en: {
                    ...
                    // FreshDesc: "산지의 신선함을 집 앞까지 배송하는 사전예약 서비스는 제철 상품을 합리적인 가격으로 제공하여 많은 사랑을 받고 있습니다. 주문한 상품을 매장에서 수령할 수 있고, 주문 방법이 어렵다면 매장으로 문의 바랍니다."
                    Steps_2: [
                        { num: "01", text: "Open Our Neighborhood GS<br />and select 'My Fridge' or 'Order History'", img: require("@/assets/images/dummy/gsrbr0401_1.png") },
                        { num: "02", text: "When selecting 'My Fridge',<br />choose your pre-ordered Children's Meal item", img: require("@/assets/images/dummy/gsrbr0401_2.png") },
                        { num: "03", text: "When selecting 'Order History',<br />tap the 'View Pickup Barcode' button", img: require("@/assets/images/dummy/gsrbr0401_3.png") },
                        { num: "04", text: "Present the barcode to the store staff", img: require("@/assets/images/dummy/gsrbr0401_4.png") }
                    ]
                }
            }
        };
