...
<style scoped>
.smn_modal { --color-brand-primary: #15b874; height: 100%; min-height: 0; flex: 1; display: flex; flex-direction: column; }
.smn_modal :deep([class*="btn_"][class*="primary"]) { color: #fff; background-color: var(--color-brand-primary); }
.modal_content { min-height: 0; flex: 1; overflow-y: auto; border-bottom: 1px solid #E5E5E9; }
.smn_title_row { flex-shrink: 0; display: flex; align-items: flex-start; justify-content: space-between; min-height: 92px; margin: 0; padding: 0; }
