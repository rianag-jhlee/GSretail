...
.body_wrap .cont_inner:nth-of-type(2) ul {border:1px solid red; width:100%; display:flex; gap:20px;}
.body_wrap .cont_inner:nth-of-type(2) ul li img {width:100%; display:block; object-fit:cover;}
.desc_section br {display:none;}
...
@media screen and (max-width: 1160px) {
    ...
    .body_wrap .cont_inner:nth-of-type(2) ul {border:1px solid red; width:100%; display:flex; flex-direction:column; gap:20px}
