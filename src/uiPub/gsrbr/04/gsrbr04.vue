...
.benefit_list li { position: relative; width: calc((100% - (20px * 2)) / 3); padding-top: 84px; }
.benefit_list li::before { position: absolute; top: 0; left: 0; width: 64px; height: 64px; background-color: #eee; border-radius: 50%; content: ''; }
